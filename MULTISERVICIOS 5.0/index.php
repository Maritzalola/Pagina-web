                ...
                <button type="button" class="btn btn-primary btn-xl text-uppercase" data-bs-toggle="modal" data-bs-target="#Registro"> REGISTRO</button>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            <a href= "Iniciodesesionempresa\loginempresa.html">
                            <button type="button" class="btn btn-primary btn-xl text-uppercase"  > LOGIN PROVEEDOR </button>
                            </a>
                            <br> </br>
                        </div>
                        <div class="modal-body">
                            <a href= "Iniciodesesionusuario\loginusuario.html">
